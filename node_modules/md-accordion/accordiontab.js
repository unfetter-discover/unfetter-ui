...
var MdAccordionTab = (function () {
    function MdAccordionTab(accordion) {
     ...
     */
    MdAccordionTab.prototype.toggle = function (event) {
        if (this.disabled) {
     ...
     */
    MdAccordionTab.prototype.findTabIndex = function () {
        var index = -1;
        for (var i = 0; i < this.accordion.tabs.length; i++) {
    ...
    ], MdAccordionTab.prototype, "mdClass", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', String)
    ], MdAccordionTab.prototype, "header", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], MdAccordionTab.prototype, "active", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
    ], MdAccordionTab.prototype, "disabled", void 0);
    MdAccordionTab = __decorate([
        core_1.Component({
            // moduleId: module.id,
        ...
        __metadata('design:paramtypes', [accordionpanel_1.MdAccordion])
    ], MdAccordionTab);
    return MdAccordionTab;
}());
exports.MdAccordionTab = MdAccordionTab;
