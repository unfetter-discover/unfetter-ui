...
export class AssessmentComponent extends Measurements implements OnChanges {
    ...
    constructor(private assessmentsService: AssessmentsService, private snackBar: MdSnackBar) {
        super();
    }
    ...
    private creatAssessmentGroups(assessedObjects: any[]): any[] {
        ...
        assessedObjects.forEach (
            ...
            assessment.kill_chain_phases = assessedObject.attributes.kill_chain_phases;
