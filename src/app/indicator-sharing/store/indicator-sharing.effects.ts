...
export class IndicatorSharingEffects {
    ...
    public startNotificationStream = this.actions$
        .ofType(indicatorSharingActions.START_SOCIAL_STREAM).pipe(
    ...
    public fetchData = this.actions$
        .ofType(indicatorSharingActions.FETCH_DATA).pipe(
    ...
    public deleteIndicator = this.actions$
        .ofType(indicatorSharingActions.START_DELETE_INDICATOR).pipe(
        switchMap((action: { type: string, payload: string }) => {
    ...
    public updateIndicator = this.actions$
        .ofType(indicatorSharingActions.START_UPDATE_INDICATOR).pipe(
        pluck('payload'),
    ...
    public addIndicator = this.actions$
        .ofType(indicatorSharingActions.ADD_INDICATOR).pipe(
    ...
    public createIndicatorToAttackPatternRelationship = this.actions$
        .ofType(indicatorSharingActions.CREATE_IND_TO_AP_RELATIONSHIP).pipe(
        pluck('payload'),
    ...
    public fetchIndicators = this.actions$
        .ofType(indicatorSharingActions.FETCH_INDICATORS).pipe(
