...
export class SummaryCalculationService {
  ...
  assessmentObjects: Assessment3Object[];
  ...
  public setAverageRiskPerAssessedObject(assessments: Array<Assessment3Object>): void {
    this.numericRisk = this.calculateAvgRiskPerAssessedObject(assessments);
  }

  public calculateAvgRiskPerAssessedObject(assessments: Array<Assessment3Object<Stix>>): number {
    let aggregateRisk = 0;
    let length = 1;
    if (assessments) {
   ...
   * @returns {void}
   */
  public populateAssessmentsGrouping(assessmentObjects: Assessment3Object[]): void {
   ...
   * @returns {void}
   */
  public populateTechniqueBreakdown(assessmentObjects: Assessment3Object[]): void {
   ...
   * @returns {string[]}
   */
  public filterOnRisk(assessment_objects: Assessment3Object[]): string[] {
  ...
  public calculateThresholdOptionNames(questionData: Assessment3Question) {
    // Default
