...
describe('SummaryCalculationService', () => {
  ...
  // it('should filter baseline objects based on selected risk', inject([SummaryCalculationService], (service: SummaryCalculationService) => {
  ...
  // it('should populate baselines grouping given an array of asssesment objects', inject([SummaryCalculationService], (service: SummaryCalculationService) => {
  //   service.summaryAggregation = null;
  //   service.populateAssessmentsGrouping(null);
  //   expect(service.baselinesGroupingTotal).toEqual({});
  ...
  //     }
  //   }]);
  //   expect(service.baselinesGroupingTotal).toEqual({ '': 1 });
  //   service.summaryAggregation = {
  //     assessedAttackPatternCountBySophisicationLevel: null,
  ...
  //     }
  //   }]);
  //   expect(service.baselinesGroupingTotal).toEqual({ 'happy camper': 1 });
  //   service.summaryAggregation = {
  //     assessedAttackPatternCountBySophisicationLevel: null,
  ...
  //     }
  //   }]);
  //   expect(service.baselinesGroupingTotal).toEqual({ 'happy camper': 2 });
  // }));
