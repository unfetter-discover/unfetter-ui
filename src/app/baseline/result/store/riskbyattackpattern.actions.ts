...
// For reducers
export const SET_RISK_BY_ATTACK_PATTERNS = '[Baseline Risk By Attack Pattern] SET_RISK_BY_ATTACK_PATTERN_DATA';
export const FINISHED_LOADING = '[Baseline Risk By Attack Pattern] FINISHED_LOADING';
export const CLEAN_ASSESSMENT_RISK_BY_ATTACK_PATTERN_DATA = '[Baseline Risk By Attack Pattern] CLEAN_ASSESSMENT_RISK_BY_ATTACK_PATTERN_DATA';
