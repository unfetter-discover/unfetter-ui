...
describe('SummaryReportComponent', () => {
  ...
  const serviceMock = {
    weakness: 'weeeeeeeak', getRiskText: string => 'risk', calculateAvgRiskPerAssessedObject: number => .33,
    summaryAggregation: {
      assessedAttackPatternCountBySophisicationLevel: { 0: 16, 1: 13, 2: 16, 3: 2 },
