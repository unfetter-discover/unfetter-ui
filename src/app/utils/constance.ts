export const Constance = {
    ...
    COURSE_OF_ACTION_URL: 'cti-stix-store-api/course-of-actions',
    ...
    INTRUSION_SET_URL: 'cti-stix-store-api/intrusion-sets',
    ...
    OBSERVED_DATA_URL: 'cti-stix-store-api/observed-data',
